...
export default function ({ musicList }) {
    ...
    const handleSelectAllClick = (event) => {
        if (event.target.checked) {
            const newSelecteds = musicList.map((n) => n.name);
            ...
            <ButtonDiv>
                ...
                <button>
                    <img
                        ...
                        alt="다운"
                        style={{ width: "17px", height: "17px", marginTop: "1px", marginBottom: "1px", marginRight: "5px" }}
                    />
                    다운
                </button>
            </ButtonDiv>
                                    ...
                                    <TableCell align="right">
                                        <Link href={row.fileUri}>
                                            <img
                                                src="data:image/png;base64,"
                                                alt="다운"
                                                style={{ width: "23px", height: "23px", marginRight: "5px", marginBottom: "3px" }}
                                            />
                                        </Link>
                                    </TableCell>
                                </TableRow>
